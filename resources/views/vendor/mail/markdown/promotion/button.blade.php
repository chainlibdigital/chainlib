...
<body>
    <div class="email-container">
        ...
        @endif
        {{-- <div class="addit">
                {{ trans('vars.Email-templates.emailOrderBodyGuestUserCabinet') }}
        </div>
        <a href="https://soledy.com" class="butt">{{ trans('vars.Auth.login') }}</a> --}}
        <p class="miss">
