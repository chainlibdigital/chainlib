			...
			<table data-vertable="ver1" class="table table-bordered">
				<thead>
					<tr class="row100 head">
                        ...
                        <th class="column-text">Biblionumber</th>
                        <th class="column-text">ISSN</th>

                        <th class="column-text">Author</th>
                        <th class="column-text">Secondary Author</th>
                        <th class="column-text">Language</th>
                        <th class="column-text">Country</th>
                        <th class="column-text">Publication</th>
                        <th class="column-text">Subject</th>
                        <th class="column-text">Description</th>
                        <th class="column-button">Image</th>
                        <th class="column-button">Similars</th>
