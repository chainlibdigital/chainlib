...
Route::group(['prefix' => $prefix], function() use ($types)  {
    ...
    Route::get('/propose-book', 'PagesController@getProposesBookPage');
    ...
    Route::post('/proposes-book', 'FeedBackController@proposesBook');
    ...
    Route::get('/resources/{alias}', 'PagesController@resourcesRender')->name('dynamic');
    Route::get('/resources/list/{alias}', 'PagesController@resourcesListRender')->name('dynamic');
