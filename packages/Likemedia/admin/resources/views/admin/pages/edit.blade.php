                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" value="{{ $page->link }}" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="img">Banner Right</label>
                            <input type="file" name="banner_right" id="img"/>
                            <br>
                            @if ($page->image_right)
                                <img src="{{ asset('/images/pages/'. $page->image_right ) }}" style="width: 70%;">
                                <input type="hidden" name="banner_right_old" value="{{ $page->image_right }}"/>
                            @else
                                <img src="{{ asset('/admin/img/noimage.jpg') }}" style="width: 70%;">
                            @endif
                            <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                @if ($page->galleryItems()->count() > 0)
                                @foreach ($page->galleryItems as $key => $item)
                                @if ($item->type == 'photo')
                                <div class="col-md-3 wrapp-full">
                                    <img src="/images/pages/og/{{ $item->src }}" alt="" class="full-width">
                                    <section>
