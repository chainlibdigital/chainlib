            ...
            @if(!is_null($menu))
                ...
                @if ($role == 'root')  {{-- root role --}}
                    @foreach($menu as $m)
                        ...
                        @endif
                    @endforeach
                @elseif ($role == 'bibliotecar')  {{-- bibliotecar role --}}
                    @foreach($menu as $m)
                        @if ( $m->src == 'feedback')
                            @if($m->src == 'products')
                                @include('admin::admin.partials.productCategories')
                        ...
                        @endif
                    @endforeach
                @elseif ($role == 'redactor')  {{-- redactor role --}}
                    @foreach($menu as $m)
                        @if (   ($m->src == 'product-categories') ||
                                ($m->src == 'products')
                            )
                            @if($m->src == 'products')
                                @include('admin::admin.partials.productCategories')
                        ...
                        @endif
                    @endforeach
                @elseif ($role == 'copyrighter')  {{-- copyrighter role --}}
                    @foreach($menu as $m)
                        @if (   ($m->src == 'pages') ||
                                ($m->src == 'blog-categories') ||
                                ($m->src == 'galleries')
                            )
                            @if($m->src == 'products')
                                @include('admin::admin.partials.productCategories')
