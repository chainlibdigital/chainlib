    ...
    public function create(Request $request)
    {
        ...
        foreach ($this->langs as $key => $lang) {
            $product->translation()->create([
                ...
                'author' => $item['author'][$lang->id],
                'co_author' => $item['co_author'][$lang->id],
                'language' => $item['language'][$lang->id],
                'country' => $item['country'][$lang->id],
                'publication' => $item['publication'][$lang->id],
                'subject' => $item['subject'][$lang->id],
