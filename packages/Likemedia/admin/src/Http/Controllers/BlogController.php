...
class BlogController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $category = BlogCategory::findOrFail($request->get('category'));

        return view('admin::admin.blogs.create', compact('categories', 'galleries', 'category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/back/blogs/category/'.$request->category_id);
    }
