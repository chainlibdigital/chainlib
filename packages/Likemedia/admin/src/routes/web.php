...
Route::group(['middleware' => ['web']], function ()
{
    ...
    Route::group(['namespace' => $namespace, 'prefix' => 'back', 'middleware' => 'auth'], function ()
    {
        ...
        //Opac Synch
        Route::get('/opac-synch', 'KohaController@index');
        Route::get('/opac-get-products-synch', 'KohaController@synchOpac');
        ...
        Route::get('/brands/clone/{id}', 'BrandsController@cloneBrand');
        ...
        Route::post('/product-categories/add-new-id', 'ProductCategoryController@addNewId');
        Route::post('/product-categories/save-edited-product', 'ProductCategoryController@saveEditedProduct');
        ...
        Route::post('/blog-categories/set-menu-status', 'BlogCategoryController@changeMenuStatus');
